...
| SHACL-lite validation   | `src/services/ShaclLiteValidator.ts`, `ShapeLoader`, `ShapeRegistry`                                    | Validates triples against shapes (required properties, cardinality, class membership with subclass closure)                                                                                            |
...
| ----------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------- |
| [`@kitelev/exocortex-obsidian-plugin`](../obsidian-plugin/) | Implements `IVaultAdapter` over the Obsidian API; renders layouts, command buttons, and SPARQL blocks driven by this engine |
