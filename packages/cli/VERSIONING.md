...
This document defines the semantic versioning policy for **@kitelev/exocortex-cli**, establishing clear stability guarantees for API consumers including MCP tools and automation scripts.
...
@kitelev/exocortex-cli follows [Semantic Versioning 2.0.0](https://semver.org/):
...
When wrapping @kitelev/exocortex-cli in MCP tools:
...
| @kitelev/exocortex-cli | MCP Tool Compatibility               |
| ---------------------- | ------------------------------------ |
