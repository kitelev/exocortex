...
`);
  ...
  // RFC c7da0bca Phase 3c-3 — deleted "Issue #3175: performance.mark
  // on fast-path first render" describe block. The fast-path branch
  // it tested has been deleted (3c-3 ctor params drop, 3c-2 source).
});
