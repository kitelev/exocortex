...
import { canMarkReviewed } from "exocortex";

describe("CommandVisibility - Mark Reviewed Command", () => {
  describe("canMarkReviewed", () => {
    it("should return true for Task with Backlog status", () => {
      ...
      expect(canMarkReviewed(context)).toBe(true);
    });
    ...
    it("should return false for archived Task", () => {
      ...
      expect(canMarkReviewed(context)).toBe(false);
    });
    ...
    it("should return false for Meeting (only Task and Project allowed)", () => {
      const context: CommandVisibilityContext = {
    ...
    it("should recognize archived as string 'true'", () => {
      const context: CommandVisibilityContext = {
        ...
        currentStatus: "[[ems__EffortStatusBacklog]]",
        metadata: {},
        isArchived: "true" as unknown as boolean,
        currentFolder: "",
        expectedFolder: null,
      };
      expect(canMarkReviewed(context)).toBe(false);
    ...
    it("should recognize archived as number 1", () => {
      const context: CommandVisibilityContext = {
        ...
        currentStatus: "[[ems__EffortStatusBacklog]]",
        metadata: {},
        isArchived: 1 as unknown as boolean,
        currentFolder: "",
        expectedFolder: null,
      };
      expect(canMarkReviewed(context)).toBe(false);
    ...
    it("should return true for Task with existing lastReviewTimestamp", () => {
      const context: CommandVisibilityContext = {
        instanceClass: "[[ems__Task]]",
        currentStatus: "[[ems__EffortStatusBacklog]]",
        metadata: { ems__Effort_lastReviewTimestamp: "2024-01-01T10:00:00" },
        isArchived: false,
        currentFolder: "",
        expectedFolder: null,
      };
    ...
    it("should return true for Project with existing lastReviewTimestamp", () => {
      const context: CommandVisibilityContext = {
        instanceClass: "[[ems__Project]]",
        currentStatus: "[[ems__EffortStatusToDo]]",
        metadata: { ems__Effort_lastReviewTimestamp: "2024-01-01T10:00:00" },
