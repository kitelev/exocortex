...
describe("ExocortexSettingTab", () => {
  ...
  describe("display", () => {
    it("should render all settings", () => {
      ...
      // 11 original settings (removed showLabelsInGraphView) + 3 headings + 1 default template + 6 per-class templates + 5 status emojis + 1 reset button + 3 webhook settings (heading, toggle, add button) = 30
