// Moved to packages/core alongside the displayName engine (req f17f7c57). Re-exported from
// the original path so the 9 importers of these symbols stay unchanged — the shim IS the
// zero-regression mechanism, not a convenience.
import type { DisplayNameSettings } from "@kitelev/exocortex-core";
import { DEFAULT_DISPLAY_NAME_SETTINGS } from "@kitelev/exocortex-core";
export type { DisplayNameSettings };
export { DEFAULT_DISPLAY_NAME_SETTINGS };
