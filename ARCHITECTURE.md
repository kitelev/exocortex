...
| **Action Buttons** (11) | `StartEffortButton`, `PlanOnTodayButton`, `VoteOnEffortButton`, `TrashEffortButton`, `RollbackStatusButton`, `MoveToToDoButton`, `ShiftDayForwardButton`, `ShiftDayBackwardButton`, `RenameToUidButton`, `RepairFolderButton`, `RdfButton` |
