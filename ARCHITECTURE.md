...
| **Action Buttons** (9) | `StartEffortButton`, `VoteOnEffortButton`, `TrashEffortButton`, `RollbackStatusButton`, `ShiftDayForwardButton`, `ShiftDayBackwardButton`, `RenameToUidButton`, `RepairFolderButton`, `RdfButton` |
