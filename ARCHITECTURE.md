...
| **Action Buttons** (10) | `StartEffortButton`, `PlanOnTodayButton`, `VoteOnEffortButton`, `TrashEffortButton`, `RollbackStatusButton`, `ShiftDayForwardButton`, `ShiftDayBackwardButton`, `RenameToUidButton`, `RepairFolderButton`, `RdfButton` |
