...
Two non-canonical legacy forms are still accepted by the converter and are **semantically equivalent** for RDF/SHACL purposes — see [`../history/DEV-TROUBLESHOOTING-plugin-incidents-2026-06-19.md`](../history/DEV-TROUBLESHOOTING-plugin-incidents-2026-06-19.md) § _exo\_\_Instance_class wikilink form mismatch — all forms RDF-equivalent_ — but new assets must not emit them:
...
[WORKFLOW_CUSTOMIZATION.md](../how-to/WORKFLOW_CUSTOMIZATION.md)) — no code change is
required.
